...
The second part of the demo does not use information from the camera but just drives 7ft to the marker, stops,
rotates 90 degrees and drives in a circle around the marker, stopping in the same spot it started (Demo2Part2)
